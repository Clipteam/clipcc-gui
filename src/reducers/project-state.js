...
const DONE_CREATING_COPY = 'clipcc-gui/project-state/DONE_CREATING_COPY';
const DONE_CREATING_NEW = 'clipcc-gui/project-state/DONE_CREATING_NEW';
const DONE_FETCHING_DEFAULT = 'clipcc-gui/project-state/DONE_FETCHING_DEFAULT';
const DONE_FETCHING_WITH_ID = 'clipcc-gui/project-state/DONE_FETCHING_WITH_ID';
const DONE_LOADING_VM_TO_SAVE = 'clipcc-gui/project-state/DONE_LOADING_VM_TO_SAVE';
const DONE_LOADING_VM_WITH_ID = 'clipcc-gui/project-state/DONE_LOADING_VM_WITH_ID';
const DONE_LOADING_VM_WITHOUT_ID = 'clipcc-gui/project-state/DONE_LOADING_VM_WITHOUT_ID';
const DONE_REMIXING = 'clipcc-gui/project-state/DONE_REMIXING';
const DONE_UPDATING = 'clipcc-gui/project-state/DONE_UPDATING';
const DONE_UPDATING_BEFORE_COPY = 'clipcc-gui/project-state/DONE_UPDATING_BEFORE_COPY';
const DONE_UPDATING_BEFORE_NEW = 'clipcc-gui/project-state/DONE_UPDATING_BEFORE_NEW';
const RETURN_TO_SHOWING = 'clipcc-gui/project-state/RETURN_TO_SHOWING';
const SET_PROJECT_ID = 'clipcc-gui/project-state/SET_PROJECT_ID';
const START_AUTO_UPDATING = 'clipcc-gui/project-state/START_AUTO_UPDATING';
const START_CREATING_NEW = 'clipcc-gui/project-state/START_CREATING_NEW';
const START_ERROR = 'clipcc-gui/project-state/START_ERROR';
const START_FETCHING_NEW = 'clipcc-gui/project-state/START_FETCHING_NEW';
const START_LOADING_VM_FILE_UPLOAD = 'clipcc-gui/project-state/START_LOADING_FILE_UPLOAD';
const START_MANUAL_UPDATING = 'clipcc-gui/project-state/START_MANUAL_UPDATING';
